...
import com.nexuratube.svg.database.models.AudioPreferences
...
import com.nexuratube.svg.database.models.DownloadItemSimple
...
import com.nexuratube.svg.database.models.VideoPreferences
import com.nexuratube.svg.database.repository.DownloadRepository
import com.nexuratube.svg.database.repository.HistoryRepository
import com.nexuratube.svg.database.repository.ResultRepository
...
import com.nexuratube.svg.util.Extensions.toListString
import com.nexuratube.svg.util.FileUtil
import com.nexuratube.svg.util.FormatUtil
import com.nexuratube.svg.util.NotificationUtil
import com.nexuratube.svg.util.extractors.ytdlp.YTDLPUtil
import com.nexuratube.svg.work.AlarmScheduler
import com.nexuratube.svg.work.UpdateMultipleDownloadsDataWorker
import com.nexuratube.svg.work.UpdateMultipleDownloadsFormatsWorker
...
class DownloadViewModel(private val application: Application) : AndroidViewModel(application) {
    ...
    fun createDownloadItemFromResult(result: ResultItem?, url: String = "", givenType: DownloadType) : DownloadItem {
        ...
        return DownloadItem(0,
            ...
            "",
            if (resultItem.playlistTitle == resultRepository.NEXURATUBE_SEARCH) "" else resultItem.playlistTitle,
            audioPreferences,
            videoPreferences,
            extraCommands,
