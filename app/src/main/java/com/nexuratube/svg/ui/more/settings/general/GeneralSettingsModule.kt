package com.nexuratube.svg.ui.more.settings.general
...
import com.nexuratube.svg.databinding.NavOptionsItemBinding
import com.nexuratube.svg.ui.adapter.IconsSheetAdapter
import com.nexuratube.svg.ui.adapter.NavBarOptionsAdapter
...
object GeneralSettingsModule : SettingModule {
    override fun bindLogic(
        ...
        when(pref.key) {
            ...
            "nexuratube_icon" -> {
                pref.apply {
                    val currentValue = preferences.getString("nexuratube_icon", "default")
                ...
                (pref as SwitchPreferenceCompat).apply {
                    setOnPreferenceChangeListener { pref, _ ->
                        ...
                        val aliasComponentName =
                            ComponentName(context, "com.nexuratube.svg.terminalShareAlias")
            ...
            "show_quick_download_share" -> {
                (pref as SwitchPreferenceCompat).apply {
                    setOnPreferenceChangeListener { pref, _ ->
                        val packageManager = context.packageManager
                        val aliasComponentName =
                            ComponentName(context, "com.nexuratube.svg.quickDownloadShareAlias")
                        if ((pref as SwitchPreferenceCompat).isChecked){
                            packageManager.setComponentEnabledSetting(aliasComponentName,
                                PackageManager.COMPONENT_ENABLED_STATE_DISABLED,
                                PackageManager.DONT_KILL_APP)
