...
import com.nexuratube.svg.MainActivity
...
import com.nexuratube.svg.database.models.SearchSuggestionItem
import com.nexuratube.svg.database.models.SearchSuggestionType
...
import com.nexuratube.svg.ui.adapter.HomeAdapter
import com.nexuratube.svg.ui.adapter.SearchSuggestionsAdapter
import com.nexuratube.svg.ui.more.cookies.WebViewActivity
import com.nexuratube.svg.util.Extensions.enableFastScroll
        ...
        lifecycleScope.launch {
            resultViewModel.playlistResults.collectLatest {
                updateMultiplePlaylistResults(it
                    .filter { it2 -> it2 != "NEXURATUBE_SEARCH" }
                )
            }
        }
