...
import com.nexuratube.svg.core.RuntimeManager
...
import com.nexuratube.svg.database.viewmodel.CookieViewModel
import com.nexuratube.svg.database.viewmodel.DownloadCardViewModel
import com.nexuratube.svg.database.viewmodel.DownloadViewModel
...
import com.nexuratube.svg.ui.BaseActivity
import com.nexuratube.svg.ui.HomeFragment
import com.nexuratube.svg.ui.downloads.DownloadQueueMainFragment
import com.nexuratube.svg.ui.downloads.HistoryFragment
import com.nexuratube.svg.ui.more.settings.SettingsActivity
import com.nexuratube.svg.util.CrashListener
import com.nexuratube.svg.util.NavbarUtil
import com.nexuratube.svg.util.NavbarUtil.applyNavBarStyle
...
class MainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        showFirstLaunchAboutDialog()
    }

    private fun showFirstLaunchAboutDialog() {
        if (preferences.getBoolean("first_launch_developer_info", true)) {
            MaterialAlertDialogBuilder(this)
                .setTitle(R.string.about_developer)
                .setMessage(HtmlCompat.fromHtml(getString(R.string.about_developer_text), HtmlCompat.FROM_HTML_MODE_COMPACT))
                .setPositiveButton(R.string.ok) { dialog, _ ->
                    preferences.edit().putBoolean("first_launch_developer_info", false).apply()
                    dialog.dismiss()
                }
                .setCancelable(false)
                .show()
