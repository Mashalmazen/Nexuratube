package com.nexuratube.svg.util.extractors.ytdlp
...
import com.nexuratube.svg.database.models.YoutubeGeneratePoTokenItem
import com.nexuratube.svg.database.models.YoutubePlayerClientItem
...
import com.nexuratube.svg.util.Extensions.getIntByAny
import com.nexuratube.svg.util.Extensions.getStringByAny
import com.nexuratube.svg.util.Extensions.isSoundCloudURL
import com.nexuratube.svg.util.Extensions.isURL
import com.nexuratube.svg.util.Extensions.isYoutubeURL
import com.nexuratube.svg.util.Extensions.isYoutubeWatchVideosURL
import com.nexuratube.svg.util.Extensions.toStringDuration
        ...
        when(type){
            DownloadType.audio -> {
                ...
                if (audioQualityId.isBlank() || listOf("0", context.getString(R.string.best_quality), "ba", "best", "", context.getString(
                    ...
                    audioQualityId = "ba/b"
                }else if(audioQualityId.contains("kbps_nexuratubegeneric")){
...
//                        }
            ...
            DownloadType.video -> {
                ...
                var abrSort = ""
                if(audioF.contains("kbps_nexuratubegeneric")){
