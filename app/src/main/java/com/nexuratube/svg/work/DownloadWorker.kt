...
import com.nexuratube.svg.database.repository.LogRepository
import com.nexuratube.svg.database.repository.ResultRepository
import com.nexuratube.svg.util.Extensions.getMediaDuration
...
import com.nexuratube.svg.util.WorkerEventBus
        ...
        queuedItems.collectLatest { items ->
            ...
            eligibleDownloads.forEach{downloadItem ->
                ...
                CoroutineScope(Dispatchers.IO).launch {
                    ...
                    // DISABLED BECAUSE YT_DLP CONSIDERS DOWNLOAD FAILURE IF -U PART FAILS, nexuratube #1043
